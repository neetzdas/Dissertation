                ...
                <div class="shadow-lg p-3 mb-3 bg-white rounded">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-12 col-lg-6 loginRight">
                            ...
                            <form method="POST" action="registerUsers" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input id="dw_consumer_id" type="number" placeholder="Consumer Id (Drinking Water)" class="form-control" name="dw_consumer_id" required>
                                </div>
